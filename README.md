...
This fork applies the following patches on top of upstream at Docker build time (see `patches/`):

| Patch | Description |
|-------|-------------|
| 001 | Unlimited Copilot headers |
| 002 | Copilot Claude endpoint routing |
| 003 | Antigravity Claude thinking signature fix |
| 004 | Antigravity assistant prefill fix |
| 005 | Merge consecutive same-role turns (Gemini API compatibility) |
